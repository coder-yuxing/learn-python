...
# 若步长为负数时，会从后往前截取
print(students[
      ::-1])  # ['zhangsan', 'damocles', 'yuxing', 'xiaohong', 'xiaoming']
...
print(
    my_list)  # ['a', 'r', 'a', 'v', 'v', 'z', 'd', 'g', 'd', 's', 'f', 'k', 'n', 'j', 'c', 'j', 'n', 'e', 'w', 'r', 'w', 'e']
my_list.sort()  # 默认正序排列
print(
    my_list)  # ['a', 'a', 'c', 'd', 'd', 'e', 'e', 'f', 'g', 'j', 'j', 'k', 'n', 'n', 'r', 'r', 's', 'v', 'v', 'w', 'w', 'z']
my_list.sort(reverse=True)
print(
    my_list)  # ['z', 'w', 'w', 'v', 'v', 's', 'r', 'r', 'n', 'n', 'k', 'j', 'j', 'g', 'f', 'e', 'e', 'd', 'd', 'c', 'a', 'a']
